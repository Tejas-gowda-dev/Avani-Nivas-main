...
export const ProcessSection: React.FC<{ onConsultationClick?: () => void }> = ({ onConsultationClick }) => {
  ...
  return (
    <section id="our-process-section" className="py-20 sm:py-12 bg-[#FAF8F5] border-t border-[#EAE4DC]">
                ...
                <div className="mt-8 space-y-6">
                  {activePhase.steps.map((step, idx) => (
                    <div key={idx} className="flex items-start gap-4 p-4 rounded-xl bg-[#FAF8F5] border border-[#ECE5DA]">
                      <div className="w-8 h-8 rounded-lg bg-[#153A66] text-white flex items-center justify-center shrink-0 text-xs font-mono font-bold">
                        0{idx + 1}
                      </div>
                      <div>
              ...
              <div className="mt-8 pt-6 border-t border-[#EAE4DC] flex flex-wrap items-center justify-between gap-4">
                ...
                {activePhaseIndex < STRUCTURED_PROCESS_PHASES.length - 1 ? (
                  <button
                    ...
                    className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#153A66] text-white text-xs font-semibold uppercase tracking-wider rounded-xl hover:bg-[#0B2545] transition-colors"
                  >
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-2 px-6 py-2.5 bg-[#153A66] text-white text-xs font-semibold uppercase tracking-wider rounded-xl hover:bg-[#0B2545] transition-colors shadow-xs"
                  >
